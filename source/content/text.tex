...
\begin{figure}[h!]
	\centering
	\includegraphics[width=1\linewidth]{source/images/ls_11}
	\caption{Least Square, 5G Koordinaten (nfg11) und Ground Truth}
	\label{fig:ls_11}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[width=1\linewidth]{source/images/ls_53}
	\caption{Least Square, 5G Koordinaten (nfg53) und Ground Truth}
	\label{fig:ls_53}
\end{figure}
