...
\begin{figure}[h!]
	\centering
	\includegraphics[width=1\linewidth]{source/images/kf_11}
	\caption{Vergleich zwischen Kalman Filter und WLS}
	\label{fig:vergleich}
\end{figure}
